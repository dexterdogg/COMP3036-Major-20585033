...
- Name: store-flow.spec.js >> Iteration 1 B2C Store E2E Flow >> student can browse products, add to cart, checkout, and view orders
- Location: tests/e2e/store-flow.spec.js:26:3
